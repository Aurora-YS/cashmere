...
//#4. 1차 배열 데이터의 개수만큼 구조를 반복하면서 각 반복하는 순서에 따라 배열 데이터의 내용을 담아서 수집하는 변수에 하나씩 추가로 담는다.
...
$c_box_frame_01.innerHTML = $c_box_01;  //최종 세개의 .cont_box를 묶어서 .content 하위에 넣어주겠다.

///////////////////////////////////////////////
//#1. 배열 데이터 구성
//2차 배열객체 패턴 ["이미지 파일명", "타이틀", "내용"]
var $cont_02 = [
